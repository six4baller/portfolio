    ...
    <>
      <div className="container contact-page">
        <div className="text-zone">
          ...
          <p>
            Want to work together? I'm open to freelance opportunities,
            especially for ambitious and large-scale projects. Get in touch
        ...
        <div className="map-wrap">
          <MapContainer center={[35.698141, 51.369106]} zoom={13}>
            ...
            <Marker position={[35.698141, 51.369106]}>
              <Popup>
                Six4 lives here,Whould you like to join me for a coffee? 🍵
              </Popup>
            </Marker>
          </MapContainer>
        </div>
